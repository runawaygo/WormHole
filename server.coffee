...
timelineUrl = "https://api.weibo.com/2/statuses/public_timeline.json?source=969200639&access_token=TOKEN"
...
.use('/callback', (req,res)->
  ...
  request.post(accessTokenLoginUrl,(err, localResponse, body)->
    ...
    console.log timelineUrl.replace('TOKEN', body.access_token)
    request.get(timelineUrl.replace('TOKEN', body.access_token), (err, localResponse,body)->
      console.log localResponse
      console.log body
      res.end body
    )
